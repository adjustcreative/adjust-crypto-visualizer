...
// var mobileDectec = new MobileDetect(window.navigator.userAgent);

// window.MOBILE = mobileDectec.mobile();
// window.SAFARI = mobileDectec.userAgent() == 'Safari';
...
//   if(volume_on){
//     $("#volume-control").removeClass("volume-on");
//     audioSoundtrack.pause();
//     volume_on=false;
//   }else{
//     $("#volume-control").addClass("volume-on");
...
//     viewport = document.querySelector("meta[name=viewport]");
//     viewport.setAttribute('content', 'width=device-width, initial-scale=0.7, maximum-scale=0.7, user-scalable=0');
